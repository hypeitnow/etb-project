...
<div class="grid gap-4 md:grid-cols-2">
    ...
    <label class="block">
        ...
        <select name="type" required class="mt-1 w-full rounded border-gray-300">
            <option value="{{ ThreeXThreeTournament::TYPE_PARTICIPATING }}" @selected($selectedType === ThreeXThreeTournament::TYPE_PARTICIPATING)>Turniej, w którym gramy</option>
    ...
    <label class="block">
        <span class="text-sm font-medium text-gray-700">Tryb zapisów</span>
        <select name="registration_mode" required class="mt-1 w-full rounded border-gray-300">
            <option value="{{ ThreeXThreeTournament::REGISTRATION_NONE }}" @selected($selectedRegistrationMode === ThreeXThreeTournament::REGISTRATION_NONE)>Brak zapisów</option>
    ...
    <label class="block">
        <span class="text-sm font-medium text-gray-700">Link do zapisów</span>
    ...
    <label class="block">
        <span class="text-sm font-medium text-gray-700">Liczba zawodników w drużynie</span>
    ...
    <label class="flex items-center gap-2 rounded border border-gray-200 p-3">
        ...
        <span class="text-sm font-medium text-gray-700">Udostępnij zapisy na stronie</span>
    </label>
