    ...
    <div class="bg-gray-100 py-10">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="rounded border border-gray-200 bg-white p-6 shadow-sm">
                <h1 class="mb-6 text-2xl font-semibold">Edytuj zawodnika</h1>
                <form action="{{ route('players.update', $player) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    @method('PUT')
