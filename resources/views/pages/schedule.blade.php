...
@section('content')
<section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" x-data="{ tab: @js($selectedView) }">
    ...
    <div class="space-y-12">
        <section x-show="tab === 'all' || tab === 'upcoming'">
            <h2 class="mb-5 text-2xl font-black text-white">Mecze nadchodzące</h2>
        ...
        <section x-show="tab === 'all' || tab === 'finished'">
            <h2 class="mb-5 text-2xl font-black text-white">Mecze zakończone</h2>
            <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
